    ...
    <div className="min-h-screen bg-[#05050a] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[#0c0c18] border border-white/[0.06] rounded-xl p-6">
          <h1 className="text-xl font-semibold text-[#eeeef0] mb-1">Sign in</h1>
          <p className="text-sm text-[#7a7a8e] mb-6">Enter your credentials to access your account</p>
        ...
        <p className="text-center text-sm text-[#4a4a5e] mt-5">
          ...
          <Link to="/register" className="text-[#4a6cf7] hover:text-[#6b8aff] transition-colors">
            Create one
          </Link>
        </p>
      </div>
